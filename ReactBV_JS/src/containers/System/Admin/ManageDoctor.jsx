...
class ManageDoctor extends Component {
  ...
  async componentDidMount() {
    ...
    //load data doctor
    let valueSelectedOption = localStorage.getItem("userValue");
    this.setState({ selectedOption: valueSelectedOption });
    let { listPayment, listPrice, listProvince, listSpecialty, listClinic } =
      this.state;
    console.log("selectedOption: ", this.state.selectedOption);
    let res = await getDetailInforDoctor(valueSelectedOption);
  ...
  handleSaveContentMarkdown = () => {
    ...
    if (
      ...
      this.state.selectedProvince !== undefined &&
      this.state.selectedClinic !== undefined
    ) {
      this.props.saveDetailDoctor({
        contentHTML: this.state.contentHTML ? this.state.contentHTML : "",
        contentMarkdown: this.state.contentMarkdown
          ? this.state.contentMarkdown
          : "",
        description: this.state.description ? this.state.description : "",
        doctorId: localStorage.getItem("userValue"),
